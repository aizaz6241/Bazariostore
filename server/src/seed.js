...
export async function runSeed() {
  ...
  const sellers = await Seller.insertMany([
    {
      ...
      address: { street: '742 Market Street', city: 'San Francisco', state: 'CA', country: 'United States' },
      bankDetails: { accountTitle: 'TechZone Enterprise Inc', accountNumber: '123456789012', bankName: 'JPMorgan Chase Bank' },
      commissionRate: 8,
      status: 'active',
      rating: 4.9,
      numReviews: 84,
    ...
    },
    {
      ...
      address: { street: '450 Oxford Street', city: 'London', state: 'Greater London', country: 'United Kingdom' },
      bankDetails: { accountTitle: 'Urban Vogue Studio Ltd', accountNumber: '987654321098', bankName: 'Barclays Bank' },
      commissionRate: 10,
      status: 'active',
      rating: 4.8,
      numReviews: 56,
    ...
    },
    {
      ...
      address: { street: '1200 Grand Avenue', city: 'Chicago', state: 'IL', country: 'United States' },
      bankDetails: { accountTitle: 'Apex Living LLC', accountNumber: '456789012345', bankName: 'Bank of America' },
      commissionRate: 12,
      status: 'active',
      rating: 4.7,
      numReviews: 39,
    ...
    },
    {
      ...
      address: { street: '750 Fifth Avenue', city: 'New York', state: 'NY', country: 'United States' },
      bankDetails: { accountTitle: 'Glow Aura Beauty Corp', accountNumber: '334455667788', bankName: 'Citibank' },
      commissionRate: 10,
      status: 'active',
      rating: 4.9,
      numReviews: 92,
  ...
  const sampleOrders = [
    {
      ...
      seller: sTech._id,
      placedBy: 'customer',
      contact: { email: 'customer@gmail.com', phone: '+1 (555) 345-6789' },
      shippingAddress: { fullName: 'Alex Miller', street: '42 Main Street, Suite 500', city: 'San Francisco', state: 'CA', postalCode: '94105', country: 'United States' },
      shipping: { name: 'Global Express 1-2 Day Delivery', cost: 15, eta: '1-2 business days' },
      items: [
        {
    ...
    },
    {
      ...
      seller: sFashion._id,
      placedBy: 'customer',
      contact: { email: 'sarah.jenkins@yahoo.com', phone: '+44 20 7946 0199' },
      shippingAddress: { fullName: 'Sarah Jenkins', street: 'Apartment 4B, Kensington High St', city: 'London', state: 'Greater London', postalCode: 'W8 5SA', country: 'United Kingdom' },
      shipping: { name: 'Standard Worldwide Shipping', cost: 0, eta: '3-5 business days' },
      items: [
        {
    ...
    },
    {
      ...
      contact: { email: 'david.chen@gmail.com', phone: '+1 (312) 555-0188' },
      shippingAddress: { fullName: 'David Chen', street: '1200 Michigan Avenue, Apt 15', city: 'Chicago', state: 'IL', postalCode: '60601', country: 'United States' },
      shipping: { name: 'Standard Worldwide Shipping', cost: 0, eta: '3-5 business days' },
      items: [
        {
    ...
    },
    {
      ...
      seller: sBeauty._id,
      placedBy: 'customer',
      contact: { email: 'emma.watson@gmail.com', phone: '+1 (212) 555-0144' },
      shippingAddress: { fullName: 'Emma Watson', street: '750 Fifth Avenue, 12th Floor', city: 'New York', state: 'NY', postalCode: '10019', country: 'United States' },
      shipping: { name: 'Global Express 1-2 Day Delivery', cost: 15, eta: '1-2 business days' },
      items: [
        {
  ...
  const chat1 = new Conversation({
    ...
    subject: 'Bulk Inventory Verification for Flagship Devices',
    status: 'open',
    priority: 'high',
  ...
  await Message.insertMany([
    {
      ...
      text: 'Hello Admin team, we want to inquire about the weekly payout settlement schedule.',
    ...
    },
    {
      ...
      text: 'Hello Alex! Weekly vendor payouts are processed every Monday directly to your registered bank account.',
  ...
  const chat2 = new Conversation({
    ...
    status: 'open',
    priority: 'normal',
    lastMessage: 'Sure Sarah, we have added your leather jackets to the Mega Flash Sale banner!',
    lastSender: 'admin',
  ...
  await Message.insertMany([
    ...
    },
    {
      ...
      text: 'Sure Sarah, we have added your leather jackets to the Mega Flash Sale banner!',
  ...
  const SITE_CONTENT = {
    topbar: {
      welcome: 'Welcome to Bazario — Premier Global Multi-Vendor Marketplace',
      promos: [
        { icon: 'badgeCheck', text: '100% Genuine Verified Global Sellers' },
        { icon: 'truck', text: 'Global Express 1-2 Day Worldwide Delivery' },
        { icon: 'banknote', text: 'Secure Checkout with Visa, Mastercard & COD' },
        { icon: 'refresh', text: 'Easy 14-Day Hassle-Free Returns' },
      ],
    },
    logo: { script: 'Bazario', name: 'MARKETPLACE', tagline: 'Earth’s Premier Selection' },
    hero: {
      slides: [
        {
          a: 'Mega Electronics &',
          b: 'Flagship Mobiles',
          sub: 'Explore Top Verified Global Sellers with Worldwide Express Delivery',
          badge: 'Up to 35% OFF',
          imgs: [
